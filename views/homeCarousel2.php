<?php
    ...
    $query = mysql_query("SELECT * from workers INNER JOIN types ON workers.typeid=types.id WHERE workers.id='2'"); //Query the users table if there are matching rows equal to $username
